...
public class Robot extends TimedRobot {
	...
	DigitalInput HighlimitSwitch, LowlimitSwitch;
	...
	public void robotInit() {
		...
		// DigitalInput LowlimitSwitch = new DigitalInput (1);
		// DigitalInput HighlimitSwitch = new DigitalInput (2);
		//server.getVideo();
	...
	public void teleopPeriodic() {
		...
		// 	//when the lower limit switch is pressed, something happens
		// } else if (HighlimitSwitch.get()) {
		// 	//when the upper limit switch is pressed, something else happens
		// }
	}
}
